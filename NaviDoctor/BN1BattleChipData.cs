...
{
    public class BN1BattleChipData
    {
        ...
        public BN1BattleChipData()
        {
        }
        
        private static Dictionary<int, string> chipNameMap = new Dictionary<int, string>()
        {
            { 1, "Cannon" },
            { 2, "HiCannon" },
            { 3, "M-Cannon" },
        ...
        {
            if (chipNameMap.ContainsKey(chipID))
            {
                return chipNameMap[chipID];
            }
            return "Unknown";
        }
        ...
        {
            foreach (KeyValuePair<int, string> chipEntry in chipNameMap)
            {
        ...
        public List<BN1BattleChipData> GenerateChipEntries()
        {
            List<BN1BattleChipData> chipEntries = new List<BN1BattleChipData>();
            ...
            foreach (var kvp in chipCodeMap)
            {
                ...
                {
                    BN1BattleChipData chipEntry = new BN1BattleChipData
                    {
